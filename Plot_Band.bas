...
Const BandLast As Integer = 80 'Avoid larger than 66
...
Const FreqMax As Integer = 2700
Const FreqMin As Integer = 0
Const FreqStep As Integer = 500
...
Const ChartHeight As Integer = 4 * 150
Const ChartWidth As Integer = (4 + 1) * 120
